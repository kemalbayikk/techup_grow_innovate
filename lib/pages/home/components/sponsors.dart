...
class Sponsors extends StatelessWidget {
  var sponsorsList = [
    new Sponsor("https://www.webtekno.com/", "assets/webtekno-logo.png", 1200, 500),
    ...
    new Sponsor("https://www.bthaber.com/", "assets/bthaber_logo-min.png", 400, 150),
    new Sponsor("http://newyorkbusinessexcellence.com/", "assets/newyork_business.jpg", 500, 500),
  ];
        ...
        Container(
            child: Text(
              ...
              style: GoogleFonts.montserrat(
                ...
                fontSize: MediaQuery.of(context).size.width < 1000 ? MediaQuery.of(context).size.width / 12 : MediaQuery.of(context).size.width / 32,
              ),
            ),
          ),
          SizedBox(height: 100),
          Container(
            child: CarouselSlider(
              options: CarouselOptions(
                ...
                initialPage: 1,
                height: 200,
                viewportFraction: MediaQuery.of(context).size.width < 1200 ?  0.7 : 0.4,
                disableCenter: true,
                aspectRatio: 16/16,
              ),
              items: sponsorsList
